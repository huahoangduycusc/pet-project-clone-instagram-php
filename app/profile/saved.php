...
<div class="body-content">
    ...
    <section class="user-posts">
        ...
        <div class="profile-tab flex">
            <a href="index.php" class="tab-content"><i class="fas fa-border-all"></i><span>POSTS</span></a>
            <a href="" class="tab-content tab-visited"><i class="far fa-bookmark"></i><span>Saved</span></a>
        </div>
        <div class="user-posts-list" id="account-saved-post">
            <?php
            $objPost = new Post();
            $myPost = $objPost->getPostSaved($id);
